...
#ifdef VMS
  ent->st_ino[0] = stats->st_ino[0];
  ent->st_ino[1] = stats->st_ino[1];
  ent->st_ino[2] = stats->st_ino[2];
#else
...
#ifdef VMS
  new_ent.st_ino[0] = stats->st_ino[0];
  new_ent.st_ino[1] = stats->st_ino[1];
  new_ent.st_ino[2] = stats->st_ino[2];
#else
